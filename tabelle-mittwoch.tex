...
\begin{center}
  ...
  & \multicolumn{1}{c}{\cellcolor{hellgruen} Weismannhaus}
    ...
    Kaffeepause} \tabularnewline
    17:00
    \talk{\cellcolor{change}Wie man mit OpenStreetMap und Open Source eine multimodale Smartphone-App für den öffentlichen Nahverkehr bauen kann}{Christoph Hanser}
